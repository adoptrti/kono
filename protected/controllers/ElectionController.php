...
class ElectionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Election']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_election));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Election');
	...
	{
		$model=new Election('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Election']))
			$model->attributes=$_GET['Election'];
	 ...
	 * @param Election $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='election-form')
		{
